...
DROP TABLE IF EXISTS DIM_PRECAUCION
DROP TABLE IF EXISTS DIM_FECHA
DROP TABLE IF EXISTS DIM_CLIENTE
DROP TABLE IF EXISTS DIM_DISTRIBUIDOR
GO
...
CREATE TABLE DIM_EMPLEADO(
	ID_EMPLEADO		INTEGER NOT NULL CONSTRAINT PK_EM PRIMARY KEY, 
	FECHA_INICIO	DATETIME
)
GO

CREATE TABLE DIM_CLIENTE (
	ID_CLIENTE		INTEGER NOT NULL CONSTRAINT PK_CL PRIMARY KEY, 
	FECHA_INICIO	DATETIME
)
GO
...
CREATE TABLE DIM_DISTRIBUIDOR (
	ID_DISTRIBUIDOR		INTEGER NOT NULL CONSTRAINT PK_DI PRIMARY KEY, 
	FECHA_INICIO		DATETIME
)
GO
...
CREATE TABLE DIM_PRECAUCION (
	ID_PRECAUCION		INTEGER NOT NULL CONSTRAINT PK_DPRECAUCION PRIMARY KEY, 
	EFECTOS_SECUNDARIOS VARCHAR(255),
	FECHA_INDICACION	DATETIME
)
GO
...
CREATE TABLE FAC_FARMACIA (
	...
	CONSTRAINT FK_FF_DPRECAUCION FOREIGN KEY (ID_PRECAUCION) REFERENCES DIM_PRECAUCION (ID_PRECAUCION),
	CONSTRAINT FK_FF_FECHA_MEDICA FOREIGN KEY (FECHA_RECETA_MEDICA) REFERENCES DIM_FECHA (FEC_ID),
	CONSTRAINT FK_FF_EM FOREIGN KEY (ID_EMPLEADO) REFERENCES DIM_EMPLEADO(ID_EMPLEADO), 
	CONSTRAINT FK_FF_DI FOREIGN KEY (ID_DISTRIBUIDOR) REFERENCES DIM_DISTRIBUIDOR(ID_DISTRIBUIDOR),
	CONSTRAINT FK_FF_CL FOREIGN KEY (ID_CLIENTE) REFERENCES DIM_CLIENTE (ID_CLIENTE)
)
GO